...
async def not_chat(_, m: Message):
    buttons = [
            [
                InlineKeyboardButton("CHANNEL", url="https://t.me/ProBinnerBD"),
                InlineKeyboardButton("SUPPORT", url="https://t.me/LIVE_CVV_CC"),
            ],
            [
                InlineKeyboardButton("🤖 OWNER 🤖", url="https://t.me/BotMakerBD"),
            ]
         ]
    k=await m.reply_photo(photo="https://telegra.ph/file/4e839766d45935998e9c6.jpg", caption="**Sorry, You Can't Use This Bot In This Group! 🤷‍♂️ But You Can Make Your Own Bot Like This From The [Source](https://t.me/BotMakerBD) Below 😉!**", reply_markup=InlineKeyboardMarkup(buttons))
    await mp.delete(m)
